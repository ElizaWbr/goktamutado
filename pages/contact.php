        ...
        <div class="background-main-box">
            ...
            <div class="full-screen flex-center">
                <div class="half-page flex-center justify-left">
                    <div class="container">
                        <a class="hiper-button" href="contact/gok-mom.php">Falar com a mãe do Gok</a>
                        <a class="hiper-button" href="contact/donation.php">Doe para essa causa <br> (Ajude-nos a desmutar o Gok)</a>
                    </div>
                </div>
                <div class="half-page flex-center justify-right">
                    <img class="image" src="../img/a-cat.png" style="transform: scaleX(-1);"/>
                </div>
            </div>
        </div>
    </body>
